...
// 按钮的边长,键盘总长度=11*BTN_SIZE,键盘总宽度=5*BTN_SIZE
#define BTN_SIZE    40
...
private:
    ...
    QPushButton *btnSign14;     //_
    QPushButton *btnSign15;     //-
    QPushButton *btnSign16;     //+
    QPushButton *btnSign17;     //"/"
    QPushButton *btnSign18;     //=
    QPushButton *btnSign19;     //[
    QPushButton *btnSign20;     //]
    QPushButton *btnSign21;     //{
    QPushButton *btnSign22;     //}
    QPushButton *btnSign23;     //|
    QPushButton *btnSign24;     //"\"
    QPushButton *btnSign25;     //'
