...
const QMetaObject wThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_wThread.data,
      qt_meta_data_wThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *wThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_wThread.stringdata0))
        return static_cast<void*>(const_cast< wThread*>(this));
